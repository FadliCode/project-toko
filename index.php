                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="assets/images/logofadli.png" alt="logo-sm-light" height="26">
                            </span>
                            <span class="logo-lg">
                                <img src="assets/images/favicon.png" alt="logo-favicon" height="24">
                            </span>
                        </a>
                    </div>
            ...
            <div class="page-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Toko Bangunan.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by padlymr
                                </div>
                            </div>
                        </div>
                    </div>
